...
namespace {
    ...
    // Membaca 4 byte sebagai integer
...
Image* loadBMP(const char* filename) {
    ...
    switch(headerSize) {
        ...
        case 40:
            ...
            assert(
                readShort(input) == 24 ||
                !"Gambar tidak 24 bits per pixel!"
            );
    ...
    auto_array<char> pixels2(
        new char[width * height * 3]
    );
